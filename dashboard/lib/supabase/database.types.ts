  ...
  public: {
    Tables: {
      ...
      jornadas: {
        ...
        Relationships: [
          {
            foreignKeyName: "jornadas_chofer_id_fkey";
            columns: ["chofer_id"];
            isOneToOne: false;
      ...
      ubicaciones_tracking: {
        ...
        Relationships: [
          {
            foreignKeyName: "ubicaciones_tracking_chofer_id_fkey";
            columns: ["chofer_id"];
            isOneToOne: false;
            referencedRelation: "choferes";
            referencedColumns: ["id"];
    ...
    Views: {
      ...
      ubicaciones_tracking_planas: {
        Row: {
          chofer_id: string | null;
          jornada_ids: string[] | null;
          lat: number | null;
          lng: number | null;
